 ...
 * through.
 *
 * The checkbox is decorative — the whole row is the tap target — so the row
 * itself carries the checkbox role and checked state for screen readers, and
 * the checkbox is hidden from them so it is not announced a second time.
 *
