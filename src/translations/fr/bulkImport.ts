...
export default {
  ...
  validation: {
    ...
    matchingTags: 'Correspondance des étiquettes...',
    ready: 'Prêt à valider',
    validatingTags: 'Validation des étiquettes',
