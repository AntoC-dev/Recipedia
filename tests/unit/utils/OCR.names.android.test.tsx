...
describe('recognizeIngredientNames on Android', () => {
  ...
  test.todo('parses ingredient names and units from Android OCR result');

  test.todo('strips box header line from Android OCR result');
      ...
      blocks: [
        {
          recognizedLanguages: [],
          text: '',
          lines: [{ elements: [], recognizedLanguages: [], text: 'Sugar (g)' }],
        },
      ],
    });
